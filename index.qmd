...
If you want my personal, non-academic analysis projects, head to the 
[Projects tab](projects.qmd). If you are here to learn, the 
[Tutorials tab](tutorials.qmd) is for you! And if you want 
to sit back and read some plain-language blog posts, there's a 
[Blog tab](blogs.qmd) just for you. Of course, if you are curious about the 
website's structure, it is built with R and Quarto, and the code is available by 
clicking on the GitHub icon at the bottom-left of every page (or click 
